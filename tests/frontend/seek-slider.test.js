...
describe("seek-slider.js", () => {
  describe("updateHoverStripProgress logic", () => {
    ...
    const updateHoverStripProgress = (
      hoverStrip,
      getCurrentIndex,
      searchResults,
    ...
    it("should set gradient with 0% yellow when at first slide", () => {
      ...
      updateHoverStripProgress(hoverStrip, mockSlideState.getCurrentIndex, null, getCurrentSlideIndex);
    ...
    it("should handle search results mode", () => {
      ...
      updateHoverStripProgress(hoverStrip, mockSlideState.getCurrentIndex, searchResults, getCurrentSlideIndex);
    ...
    it("should not throw when hoverStrip is null", () => {
      ...
      expect(() =>
        updateHoverStripProgress(null, mockSlideState.getCurrentIndex, null, getCurrentSlideIndex)
      ).not.toThrow();
    });

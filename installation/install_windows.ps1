...
# 2. Set default install location to AppData\Local\Programs\ClipSlide
$envUser = $env:USERNAME
$defaultInstallDir = "C:\Users\$envUser\AppData\Local\Programs\ClipSlide"

$installDir = Read-Host "Enter install location for ClipSlide virtual environment [`$defaultInstallDir`]"
...
# 4. Activate virtual environment and install ClipSlide
...
Write-Host "Activating virtual environment and installing ClipSlide..."
& $venvActivate
...
Write-Host "You can run this script to start the ClipSlide server." -ForegroundColor Yellow
